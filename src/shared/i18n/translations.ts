...
export const translations = {
  [LANGUAGE.EN]: {
    ...
    "settings.menu.signIn": "Sign in",
    "auth.signIn.title": "Sign in",
    "auth.signIn.submit": "Sign in",
    "auth.signIn.noAccount": "Don't have an account?",
    "auth.signIn.signUpLink": "Create one",
    "auth.signIn.forgotPassword": "Forgot your password?",
    "auth.signIn.warnTitle": "Sign in to your account",
    "auth.signIn.warnMessage":
      "Signing in replaces the data on this device with your account's data. Your current local data will be lost.",
    "auth.signIn.warnConfirm": "Sign in",
    "auth.signUp.title": "Create account",
    "auth.signUp.submit": "Create account",
    "auth.signUp.haveAccount": "Already have an account?",
    "auth.signUp.signInLink": "Sign in",
    "auth.confirm.headerTitle": "Confirm your email",
    ...
    "auth.changePassword.menu": "Change password",
    ...
    "auth.changePassword.doneTitle": "Password updated",
    ...
    "auth.field.confirmPasswordPlaceholder": "Repeat your password",
    ...
    "auth.validation.passwordTooShort": "Use at least 6 characters",
    ...
    "dashboard.editMode.action": "Edit dashboard",
    "dashboard.editMode.done": "Done editing",
    ...
    "dashboard.filter.excludeOppositeCategories": "Excluded (opposite type)",
    "dashboard.filter.excluding": "Excludes {categories}",
    ...
    "dashboard.preset.last7Days": "Last 7 days",
    "dashboard.preset.last30Days": "Last 30 days",
    ...
    "dashboard.recentTransactions.action": "Recent transactions",
    "dashboard.categoryBreakdown.action": "By category",
  ...
  [LANGUAGE.ES]: {
    ...
    "settings.menu.signIn": "Iniciar sesión",
    "auth.signIn.title": "Iniciar sesión",
    "auth.signIn.submit": "Iniciar sesión",
    "auth.signIn.noAccount": "¿No tienes cuenta?",
    "auth.signIn.signUpLink": "Crea una",
    "auth.signIn.forgotPassword": "¿Olvidaste tu contraseña?",
    "auth.signIn.warnTitle": "Inicia sesión en tu cuenta",
    "auth.signIn.warnMessage":
      "Iniciar sesión reemplaza los datos de este dispositivo con los de tu cuenta. Perderás tus datos locales actuales.",
    "auth.signIn.warnConfirm": "Iniciar sesión",
    "auth.signUp.title": "Crear cuenta",
    "auth.signUp.submit": "Crear cuenta",
    "auth.signUp.haveAccount": "¿Ya tienes cuenta?",
    "auth.signUp.signInLink": "Inicia sesión",
    "auth.confirm.headerTitle": "Confirma tu correo",
    "auth.confirm.title": "Revisa tu bandeja",
    "auth.confirm.message":
      "Enviamos un enlace de confirmación a {email}. Ábrelo para activar tu cuenta.",
    "auth.confirm.resend": "Reenviar correo",
    "auth.confirm.backToSignIn": "Volver a iniciar sesión",
    "auth.recovery.title": "Restablecer contraseña",
    "auth.recovery.description":
      "Introduce el correo de tu cuenta y te enviaremos un enlace para restablecer la contraseña.",
    "auth.recovery.submit": "Enviar enlace",
    "auth.recovery.backToSignIn": "Volver a iniciar sesión",
    "auth.recovery.sentTitle": "Revisa tu bandeja",
    "auth.recovery.sentMessage":
      "Si ese correo tiene cuenta, el enlace de restablecimiento va en camino. Ábrelo para poner una nueva contraseña.",
    "auth.changePassword.title": "Cambiar contraseña",
    "auth.changePassword.menu": "Cambiar contraseña",
    ...
    "auth.changePassword.doneTitle": "Contraseña actualizada",
    "auth.field.email": "Correo",
    "auth.field.emailPlaceholder": "tu@ejemplo.com",
    "auth.field.password": "Contraseña",
    "auth.field.passwordPlaceholder": "Tu contraseña",
    "auth.field.confirmPassword": "Confirmar contraseña",
    "auth.field.confirmPasswordPlaceholder": "Repite tu contraseña",
    ...
    "auth.validation.passwordTooShort": "Usa al menos 6 caracteres",
    ...
    "transactions.summary.income": "Entrada",
    "transactions.summary.expense": "Salida",
    ...
    "dashboard.editMode.action": "Editar panel",
    "dashboard.editMode.done": "Listo",
    ...
    "dashboard.filter.excludeOppositeCategories": "Excluidas (tipo opuesto)",
    "dashboard.filter.excluding": "Excluye {categories}",
    ...
    "dashboard.preset.last7Days": "Últimos 7 días",
    "dashboard.preset.last30Days": "Últimos 30 días",
    ...
    "dashboard.recentTransactions.action": "Transacciones recientes",
    "dashboard.categoryBreakdown.action": "Por categoría",

...
import { type LocalCategoryClient } from "#features/categories/clients/LocalCategoryClient"
import {
...
import { type RemoteTransaction } from "../RemoteTransactionClient"
...
import { isoToStamp } from "../RemoteTransactionClient/utils"
...
export default class LocalTransactionClient extends StorageClient<StoredTransaction> {
  readonly #accounts: LocalAccountClient
  readonly #categories: LocalCategoryClient

  constructor(accounts: LocalAccountClient, categories: LocalCategoryClient) {
    super({

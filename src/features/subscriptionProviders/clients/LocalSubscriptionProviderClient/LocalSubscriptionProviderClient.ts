...
import { type RemoteSubscriptionProvider } from "../RemoteSubscriptionProviderClient"
...
export default class LocalSubscriptionProviderClient extends StorageClient<SubscriptionProvider> {
  constructor() {
    super({

...
export const fetchSubscriptionProviders = async (): Promise<
...
export const createSubscriptionProvider = (
...
export const updateSubscriptionProvider = (
  remoteId: number,
  body: SubscriptionProviderPayload,
): Promise<number> =>
...
export const deleteSubscriptionProviders = (
  remoteIds: number[],
): Promise<number> =>
  authRequest<number>(SUBSCRIPTION_PROVIDERS_ENDPOINT, {
    method: "DELETE",
